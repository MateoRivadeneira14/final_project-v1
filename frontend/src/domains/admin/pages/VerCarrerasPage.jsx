...
export default function VerCarrerasPage() {
            ...
            <div className="overflow-x-auto p-6">
              <table className="min-w-full border border-gray-300 bg-white rounded">
                <thead className="bg-gray-100">
                  <tr>
                    <th className="text-left px-4 py-2 border-b">Nombre Carrera</th>
                ...
                <tbody>
                  {items.map((item, index) => (
                    <tr key={index} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-2 border-b">{item.Facultad?.Universidad?.nombre || "-"}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
